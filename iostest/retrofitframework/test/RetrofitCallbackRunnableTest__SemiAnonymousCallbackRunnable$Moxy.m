...
#include "RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable$Moxy.h"
...
@implementation RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy
...
- (instancetype)initWithRetrofitCallback:(id<RetrofitCallback>)a0
  ...
  RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy_initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_(self, a0, a1, a2);
  return self;
}
...
- (RetrofitResponseWrapper *)obtainResponse {
  @try {
    if ($__handler_ == nil) {
      ...
      return (RetrofitResponseWrapper *) cast_chk([$__handler_ invokeWithId:self withJavaLangReflectMethod:[[self java_getClass] getMethod:@"obtainResponse" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:IOSClass_class_()]] withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:NSObject_class_()]], [RetrofitResponseWrapper class]);
    }
  }
  @catch (NSException *__ttlive) {
    if ([__ttlive isKindOfClass:[JavaLangRuntimeException class]]) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(obtainResponse);
  methods[6].selector = @selector(super$obtainResponse);
  ...
  static const void *ptrTable[] = { "LRetrofitCallback;LJavaUtilConcurrentExecutor;LRetrofitErrorHandler;", "setHandler", "LJavaLangReflectInvocationHandler;", "clone", "LJavaLangCloneNotSupportedException;", "hashCode", "equals", "LNSObject;", "super$equals", "toString" };
  static const J2ObjcClassInfo _RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy = { "CallbackRunnableTest__SemiAnonymousCallbackRunnable$Moxy", "retrofit", ptrTable, methods, fields, 7, 0x1, 13, 1, -1, -1, -1, -1, -1 };
  return &_RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy;
}
...
void RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy_initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_(RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy *self, id<RetrofitCallback> a0, id<JavaUtilConcurrentExecutor> a1, id<RetrofitErrorHandler> a2) {
  RetrofitCallbackRunnableTest_SemiAnonymousCallbackRunnable_initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_(self, a0, a1, a2);
}

RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy *new_RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy_initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_(id<RetrofitCallback> a0, id<JavaUtilConcurrentExecutor> a1, id<RetrofitErrorHandler> a2) {
  J2OBJC_NEW_IMPL(RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy, initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_, a0, a1, a2)
}

RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy *create_RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy_initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_(id<RetrofitCallback> a0, id<JavaUtilConcurrentExecutor> a1, id<RetrofitErrorHandler> a2) {
  J2OBJC_CREATE_IMPL(RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy, initWithRetrofitCallback_withJavaUtilConcurrentExecutor_withRetrofitErrorHandler_, a0, a1, a2)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RetrofitCallbackRunnableTest__SemiAnonymousCallbackRunnable_Moxy)
