...
#include "RetrofitRxSupportTest__MockSubscriber$Moxy.h"
...
@implementation RetrofitRxSupportTest__MockSubscriber_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RetrofitRxSupportTest__MockSubscriber_Moxy_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "setHandler", "LJavaLangReflectInvocationHandler;", "clone", "LJavaLangCloneNotSupportedException;", "hashCode", "equals", "LNSObject;", "super$equals", "toString", "onNext", "super$onNext", "onError", "LNSException;", "super$onError" };
  static const J2ObjcClassInfo _RetrofitRxSupportTest__MockSubscriber_Moxy = { "RxSupportTest__MockSubscriber$Moxy", "retrofit", ptrTable, methods, fields, 7, 0x1, 17, 1, -1, -1, -1, -1, -1 };
  return &_RetrofitRxSupportTest__MockSubscriber_Moxy;
}

@end

void RetrofitRxSupportTest__MockSubscriber_Moxy_init(RetrofitRxSupportTest__MockSubscriber_Moxy *self) {
  RetrofitRxSupportTest_MockSubscriber_init(self);
}

RetrofitRxSupportTest__MockSubscriber_Moxy *new_RetrofitRxSupportTest__MockSubscriber_Moxy_init() {
  J2OBJC_NEW_IMPL(RetrofitRxSupportTest__MockSubscriber_Moxy, init)
}

RetrofitRxSupportTest__MockSubscriber_Moxy *create_RetrofitRxSupportTest__MockSubscriber_Moxy_init() {
  J2OBJC_CREATE_IMPL(RetrofitRxSupportTest__MockSubscriber_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RetrofitRxSupportTest__MockSubscriber_Moxy)
