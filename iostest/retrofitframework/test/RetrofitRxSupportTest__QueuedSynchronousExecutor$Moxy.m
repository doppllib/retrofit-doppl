...
#include "RetrofitRxSupportTest__QueuedSynchronousExecutor$Moxy.h"
...
@implementation RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy = { "RxSupportTest__QueuedSynchronousExecutor$Moxy", "retrofit", ptrTable, methods, fields, 7, 0x1, 13, 1, -1, -1, -1, -1, -1 };
  return &_RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy;
}

@end

void RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy_init(RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy *self) {
  RetrofitRxSupportTest_QueuedSynchronousExecutor_init(self);
}

RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy *new_RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy_init() {
  J2OBJC_NEW_IMPL(RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy, init)
}

RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy *create_RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy_init() {
  J2OBJC_CREATE_IMPL(RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RetrofitRxSupportTest__QueuedSynchronousExecutor_Moxy)
