...
#include "RetrofitRxSupportTest__SpyRequestInterceptor$Moxy.h"
...
@implementation RetrofitRxSupportTest__SpyRequestInterceptor_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RetrofitRxSupportTest__SpyRequestInterceptor_Moxy_init(self);
  return self;
}
...
- (void)interceptWithRetrofitRequestInterceptor_RequestFacade:(id<RetrofitRequestInterceptor_RequestFacade>)request {
  @try {
    if ($__handler_ == nil) {
      [super interceptWithRetrofitRequestInterceptor_RequestFacade:request];
    }
    else {
      [$__handler_ invokeWithId:self withJavaLangReflectMethod:[[self java_getClass] getMethod:@"intercept" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ RetrofitRequestInterceptor_RequestFacade_class_() } count:1 type:IOSClass_class_()]] withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ request } count:1 type:NSObject_class_()]];
    }
  }
  @catch (NSException *__ttlive) {
    if ([__ttlive isKindOfClass:[JavaLangRuntimeException class]]) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(super$interceptWithRetrofitRequestInterceptor_RequestFacade:);
  ...
  static const void *ptrTable[] = { "setHandler", "LJavaLangReflectInvocationHandler;", "clone", "LJavaLangCloneNotSupportedException;", "intercept", "LRetrofitRequestInterceptor_RequestFacade;", "super$intercept", "hashCode", "equals", "LNSObject;", "super$equals", "toString" };
  static const J2ObjcClassInfo _RetrofitRxSupportTest__SpyRequestInterceptor_Moxy = { "RxSupportTest__SpyRequestInterceptor$Moxy", "retrofit", ptrTable, methods, fields, 7, 0x1, 13, 1, -1, -1, -1, -1, -1 };
  return &_RetrofitRxSupportTest__SpyRequestInterceptor_Moxy;
}

@end

void RetrofitRxSupportTest__SpyRequestInterceptor_Moxy_init(RetrofitRxSupportTest__SpyRequestInterceptor_Moxy *self) {
  RetrofitRxSupportTest_SpyRequestInterceptor_init(self);
}

RetrofitRxSupportTest__SpyRequestInterceptor_Moxy *new_RetrofitRxSupportTest__SpyRequestInterceptor_Moxy_init() {
  J2OBJC_NEW_IMPL(RetrofitRxSupportTest__SpyRequestInterceptor_Moxy, init)
}

RetrofitRxSupportTest__SpyRequestInterceptor_Moxy *create_RetrofitRxSupportTest__SpyRequestInterceptor_Moxy_init() {
  J2OBJC_CREATE_IMPL(RetrofitRxSupportTest__SpyRequestInterceptor_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RetrofitRxSupportTest__SpyRequestInterceptor_Moxy)
