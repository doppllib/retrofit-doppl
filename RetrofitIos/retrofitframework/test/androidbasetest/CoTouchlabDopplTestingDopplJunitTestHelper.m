...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(runWithNSStringArray:withOrgJunitRunnerNotificationRunListener:withCoTouchlabDopplTestingDopplJunitTestHelper_DopplJunitListener:);
  ...
  methods[7].selector = @selector(runWithIOSClassArray:withOrgJunitRunnerNotificationRunListener:withCoTouchlabDopplTestingDopplJunitTestHelper_DopplJunitListener:);
  methods[8].selector = @selector(newRunListenerWithCoTouchlabDopplTestingDopplJunitTestHelper_OutputFormat:);
  methods[9].selector = @selector(sortClassesWithIOSClassArray:withCoTouchlabDopplTestingDopplJunitTestHelper_SortOrder:);
  methods[10].selector = @selector(replaceAllWithNSString:);
  methods[11].selector = @selector(getSortKeyWithIOSClass:withCoTouchlabDopplTestingDopplJunitTestHelper_SortOrder:);
